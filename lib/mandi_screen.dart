...
class MandiScreen extends StatefulWidget {
  ...
  String businessName;
  String type;
  MandiScreen(this.clientId,this.userProducts,this.mainContext,this.businessId,this.businessName,this.type);

  @override
  _MandiScreen createState() => _MandiScreen();
}

class _MandiScreen extends State<MandiScreen> {
  String _description;
            ...
            child: Column(
              children: <Widget>[
                          ...
                          children: <Widget>[
                                      ...
                                      child: Container(
                                        //color: Colors.deepOrangeAccent,
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Icon(
                                              Icons.arrow_back,
                                              color: Color(0xFFe74b64),//Colors.white,
                            ...
                            Container(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: "https://static.wixstatic.com/media/07fea2_22f6354b499e4d49997e252935ce6964~mv2.png",
                              ),
                            ),
                          ],
                        ),
                ...
                Container(
                  ...
                  child: StreamBuilder(
                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Perro").snapshots(),
                            ...
                            child: Container(
                                ...
                                child:  Column(
                                  children: <Widget>[
                                    ...
                                    StreamBuilder(
                                      stream: Firestore.instance.collection("businesses").document(widget.businessId).snapshots(),
                                      builder: (BuildContext context, AsyncSnapshot snapshot){
                                        if(!snapshot.hasData){
                                          return Container(
                                            child: CircularProgressIndicator(),
                                          ...
                                          return Container(
                                              ...
                                              child:  Material(
                                                ...
                                                child: InkWell(
                                                  onTap: (){
                                                    Navigator.push(
                                                        context, ScaleRoute(page: PersonalizeMandi(userId: widget.clientId,
                                                      userProducts: widget.userProducts,productBackgroundColor: Color(0xFFe74b64), mainContext:
                                                      widget.mainContext, businessId: widget.businessId,provider: snapshot.data["firstName"],type: widget.type,
                                                    )));
                                                  },
                                                  child: Container(
                                                      decoration: BoxDecoration(
                                                        ...
                                                        children: <Widget>[
                                                          Opacity(
                                                            ...
                                                            child:  Container(
                                                              ...
                                                              height: SizeConfig.safeBlockVertical*20,
                                                              child: CachedNetworkImage(
                                                                imageUrl: "https://static.wixstatic.com/media/07fea2_66dcb87ebb534b418ba0aad466e709a5~mv2.png",
  ...
  Widget buildResultCard2(String productName, String image,int productPrice, int productUnits,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: (productUnits==0)? Colors.grey : Color(0xFFe74b64),)
      ),
      child: Column(
        children: <Widget>[
          Container(
          ...
          Container(
              decoration: BoxDecoration(
                ...
                color: (productUnits==0)? Colors.grey : Color(0xFFe74b64),
              ),
              width: double.infinity,
              height: cardHeight,
              child:  ButtonTheme(
                    ...
                    onPressed: (){
                      if(productUnits==0){
                       ...
                       Navigator.push(
                          ...
                          productId: productId,productCost: productCost,category: category,productBackgroundColor:  Color(0xFFe74b64),
                        )));
                        print("LO QUIERO");
                      }
                    },
