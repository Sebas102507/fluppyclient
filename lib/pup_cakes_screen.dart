...
class PupCakeScreen extends StatefulWidget {
  String clientId;
  ...
  String businessName;
  String type;
  PupCakeScreen(this.clientId,this.userProducts,this.mainContext,this.businessId,this.businessName,this.type);

  @override
  _PupCakeScreen createState() => _PupCakeScreen();
}

class _PupCakeScreen extends State<PupCakeScreen> {
  String _description;
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: "https://static.wixstatic.com/media/07fea2_fff21df5f5324ac6a71f2355017e29a4~mv2.png",
                                  ),
                                ),
                              ],
                            ),
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  child: StreamBuilder(
                                                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Combos${widget.type}").snapshots(),
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  height: SizeConfig.blockSizeVertical*25,
                                                  child: StreamBuilder(
                                                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Pasteleria${widget.type}").snapshots(),
                                                      builder: (BuildContext context, AsyncSnapshot snapshot){
                                                        if(!snapshot.hasData){
                                                          return Container(
                                                            child: Center(
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          Container(
                                            ...
                                            child:  Align(
                                              alignment: Alignment.centerLeft,
                                              child: Text("Accesorios y decoración",
                                                style: TextStyle(
                                                  color: Color(0xFF211551),
                                                  fontSize: SizeConfig.blockSizeVertical*2.5,
                                                  fontFamily: "RobotoRegular",
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  height: SizeConfig.blockSizeVertical*25,
                                                  child: StreamBuilder(
                                                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Accesorios${widget.type}").snapshots(),
                                                      builder: (BuildContext context, AsyncSnapshot snapshot){
                                                        if(!snapshot.hasData){
                                                          return Container(
                                                            child: Center(
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  height: SizeConfig.blockSizeVertical*25,
                                                  child: StreamBuilder(
                                                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Juguetes${widget.type}").snapshots(),
                                                      builder: (BuildContext context, AsyncSnapshot snapshot){
                                                        if(!snapshot.hasData){
                                                          return Container(
                                                            child: Center(
  ...
  Widget buildResultCard2(String productName, String image,int productPrice, int productUnits,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(color: (productUnits==0)? Colors.grey : Color(0xFF7cdde9),)
      ),
      child: Column(
        children: <Widget>[
          Container(
          ...
          Container(
              decoration: BoxDecoration(
                ...
                color: (productUnits==0)? Colors.grey : Color(0xFF7cdde9),
              ),
              width: double.infinity,
              height: cardHeight,
              child:  ButtonTheme(
                    ...
                    onPressed: (){
                      if(productUnits==0){
                        ...
                        Navigator.push(
                          ...
                          productId: productId,productCost: productCost,category: category,productBackgroundColor:  Color(0xFF7cdde9),
                        ))).then((userProductList) {
                          setState(() {
                            widget.userProducts=userProductList;
                          });
