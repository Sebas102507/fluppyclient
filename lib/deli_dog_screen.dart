...
class DeliDogScreen extends StatefulWidget {
  String clientId;
  ...
  String businessName;
  String type;
  DeliDogScreen(this.clientId,this.userProducts,this.mainContext,this.businessId,this.businessName,this.type);

  @override
  _DeliDogScreen createState() => _DeliDogScreen();
}

class _DeliDogScreen extends State<DeliDogScreen> {
  String _description;
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: "https://static.wixstatic.com/media/07fea2_d63c82a940a243a7ba022ceda4a331b9~mv2.png",
                                  ),
                                ),
                              ],
                            ),
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  child: StreamBuilder(
                                                      stream: Firestore.instance.collection('businessesProducts').document(widget.businessId).collection("${widget.businessName}Boutique${widget.type}").snapshots(),
  ...
  Widget buildResultCard2(String productName, String image,int productPrice, int productUnits,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(color: (productUnits==0)? Colors.grey : Color(0xFFeba1ba),)
      ),
      child: Column(
        children: <Widget>[
          Container(
          ...
          Container(
              decoration: BoxDecoration(
                ...
                color: (productUnits==0)? Colors.grey : Color(0xFFeba1ba),
              ),
              width: double.infinity,
              height: cardHeight,
              child:  ButtonTheme(
                    ...
                    onPressed: (){
                      if(productUnits==0){
                        ...
                        Navigator.push(
                          ...
                          productId: productId,productCost: productCost,category: category,productBackgroundColor:  Color(0xFFeba1ba),
                        ))).then((userProductList) {
                          setState(() {
                            widget.userProducts=userProductList;
                          });
